...
var latestmilestone = "1.0.0";
var latestmilestoneName = "Mozilla 1.0"
var osxNightly = "mozilla-macosX-trunk.smi.bin";
var osxRelease = "mozilla-macosX-10.smi.bin";
var os9Nightly = "mozilla-mac-trunk-full.bin";
var os9Release = "mozilla-mac-10-full-instal.bin";
var win32Nightly = "mozilla-win32-installer-sea.exe";
var win32Release = "mozilla-win32-1.0-installer.exe";
var x86LinuxNightly = "mozilla-i686-pc-linux-gnu-sea.tar.gz";
var x86LinuxRelease = "mozilla-i686-pc-linux-gnu-1.0-sea.tar.gz";
...
var releasedir = "http://ftp.mozilla.org/pub/mozilla/releases/mozilla1.0/";


// Leave the <p>'s where they are! This works around a Mozilla rendering bug.
var webError = new Array();
webError[0] = '<span class=\"warning\">Warning!</span><p> Your copy of Mozilla is vulnerable to a <a href=\"http://groups.google.com/groups?as_umsgid=3CD095D4.9050003%40mozilla.org&amp;hl=en\"> security bug</a>. You should fix this problem by downloading and installing the latest Mozilla build, #Milestone#.';
webError[1] = '<p>Note: you are using an old nightly build of Mozilla. Please help us out by testing #Nightly# instead.';
webError[2] = '<p>Note: you are using an old Mozilla milestone. Please help us out by testing the latest one, #Milestone#, instead.';
