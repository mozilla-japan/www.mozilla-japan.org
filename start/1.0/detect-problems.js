...
webError[0] = '<p><span class=\"warning\">警告！</span><p> あなたがお使いの Mozilla には、<a href=\"http://groups.google.com/groups?as_umsgid=3CD095D4.9050003%40mozilla.org&amp;hl=en\">セキュリティ・バグ</a> に対する脆弱性が存在します。最新の Mozilla ビルド #Milestone# をダウンロード・インストールして、この問題を解決してください。</p>';
webError[1] = '<p>注意 : あなたは Mozilla の古いナイトリービルドを使っています。代わりに #Nightly# をテストして、私たちを手伝ってください。</p>';
...
webError[2] = '<p style="border:0.4em solid #000; margin:1em; background-color:#ddd;padding:1.5em">あなたがもし最前線で生きることを大変好むのなら、#Milestone# をダウンロード・テストして、私たちを手伝ってください。そうでなければ、このメッセージを無視して、決定的なリリースを待ってください。</p>';
...
function createErrorMessages() {
   ...
   var nightlyLink = '<a href=\"' + nurl + '\" class=\"nversion\">最新のナイトリービルド</a>';
